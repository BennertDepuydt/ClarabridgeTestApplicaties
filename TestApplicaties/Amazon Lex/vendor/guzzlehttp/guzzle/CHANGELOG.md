...
Please refer to [UPGRADING](ClarabridgeTestApplicaties/TestApplicaties/Amazon Lex/vendor/guzzlehttp/guzzle/UPGRADING.md) guide for upgrading to a major version.
...
Please see [the upgrade document](ClarabridgeTestApplicaties/TestApplicaties/Amazon Lex/vendor/guzzlehttp/guzzle/UPGRADING.md) that describes all BC breaking changes.
